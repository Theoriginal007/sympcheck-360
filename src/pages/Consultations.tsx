...
import { Video, MessageSquare, Phone, Clock, Calendar as CalendarIcon, User, CheckCircle2 } from 'lucide-react';

// Mock data for doctors
const doctors = [
  { id: 1, name: "Dr. Sarah Kimani", specialty: "General Practitioner", image: "https://i.pravatar.cc/150?img=32", available: true },
  { id: 2, name: "Dr. James Ouma", specialty: "Pediatrician", image: "https://i.pravatar.cc/150?img=60", available: true },
  { id: 3, name: "Dr. Lucy Njeri", specialty: "Cardiologist", image: "https://i.pravatar.cc/150?img=40", available: false },
  { id: 4, name: "Dr. Michael Wafula", specialty: "Dermatologist", image: "https://i.pravatar.cc/150?img=52", available: true },
];
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <Input type="tel" placeholder="+254 XXX XXX XXX" />
                                </div>
                                <div>
